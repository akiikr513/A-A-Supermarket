  ...
  <body  style="BACKGROUND-COLOR:ivory;">
    ...
    <div class="container-fluid">
      ...
      <form method="post" id="invoice_form">
        <div class="table-responsive">
          <table class="table table-bordered">
            <tr>
              <td colspan="2" align="center"><h2 style="margin-top:10.5px"><u><font color="rosybrown">GENERATE BILL</font></u></h2></td>
            </tr>
            <tr>
                <td colspan="2">
                  <div class="row">
      ...
      ?><div id="view" style="position:absolute; top: 30px; left: 1000px;"><b><i><a href="employeehome.php" align="right"> Home </a>| <a href="logout.php">Logout</a></i></b></div>
		<br><br><h2 align="center"><u><b><font color="rosybrown"> BILLING</font></b></u></h4>
      <br />
      <div align="right">
